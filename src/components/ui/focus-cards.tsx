      ...
      {open && (
        ...
        >
          ...
          <motion.div
            ref={modalRef}
            className={cn(
              "h-[80%] md:max-w-[30%] bg-white dark:bg-neutral-950 border border-transparent dark:border-neutral-800 md:rounded-2xl relative z-50 flex flex-col items-start justify-end flex-1 overflow-hidden"
            )}
            initial={{
              opacity: 0,
              scale: 0.5,
          ...
          >
            ...
            <Image
              ...
              height={1080}
              width={1080}
              className="object-cover object-center absolute top-0 h-[70%] inset-0"
            />
            <div
              className={cn(
                "relative flex flex-col items-start justify-end py-4 px-4 transition-opacity duration-300 overflow-auto max-h-[30%]"
              )}
            >
              ...
              <ul className="flex items-center space-x-4 mt-1">
                <li className="w-10 h-10 border rounded-full flex items-center justify-center">
                  <Link href={`https://www.facebook.com/${details.fb}`} target="_blank">
                    <svg
                ...
                <li className="w-10 h-10 border rounded-full flex items-center justify-center">
                        <Link href={`https://www.github.com/${details.github}`} target="_blank">
...
export function FocusCards({ cards }: { cards: Member[] | undefined }) {
  ...
  return (
    <div className="flex flex-wrap items-center justify-center gap-10 max-w-5xl my-10 mx-auto md:px-8 w-full">
      <Modal>
