        ...
        <div className="flex lg:flex-row flex-col">
          <div className="flex-1 bg-black/10 m-2 rounded-md backdrop-blur-lg">
            ...
            <p className="sm:text-md text-xl font-bold relative z-20 bg-clip-text text-transparent bg-neutral-200 p-8 text-center">
              Here we meet to discuss and talk about the latest ongoing research
              in this field. This is conducted weekly on Friday night of 2 hours
              long duration. Where interested students present a short talk on
              some latest articles which they found to be interesting to share.
              This helps significantly in developing and maintaining curiosity
              and in spreading the latest research among the campus. Have a look
              at our activities in the journal club here.
            </p>
          </div>
          <div className="flex-1 bg-black/10 m-2 rounded-md backdrop-blur-lg">
            <h2 className="text-3xl md:text-2xl font-bold relative z-20 bg-clip-text text-transparent bg-gradient-to-b from-neutral-200 to-neutral-500 py-8 text-center">
            ...
            <p className="sm:text-md text-xl font-bold relative z-20 bg-clip-text text-transparent bg-neutral-200 p-8 text-center">
              We promote three types of projects:<br/> <strong>Replications of previous work:</strong>
              ...
              whether those results can be reproduced or not.<br/> <strong>Working on a new
              idea:</strong> We also support some of the projects on the latest ongoing
              research in our area of interest.<br/> <strong>Projects for Learning:</strong> Many of
              the projects are encouraged just for learning purposes. To provide
